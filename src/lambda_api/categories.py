...
def lambda_handler(event, context):
    """
    AWS Lambda handler for categories-related API requests.
    """
    get_paths = {
        RoutePattern.Categories.BASE.value: categories.get_all_categories,
    }
    post_paths = {
        # RoutePattern.Products.BASE: categories.,
        # RoutePattern.Products.ATTACH_PICTURE: categories.attach_picture_to_product,
    }
    path = event.get("path", "")
